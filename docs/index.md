...
![A gradepath discrimination report card: 97 firms sorted by posterior
evidence into three integer grades along the information-reliability
frontier, each firm shown with a posterior point and a credible
interval.](reference/figures/README-report-card-1.png)
...
MIT © JoonHo Lee. See
[`LICENSE.md`](https://joonho112.github.io/gradepath/LICENSE.md).
